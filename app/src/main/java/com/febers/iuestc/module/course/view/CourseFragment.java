    ...
    public void showUnderCourse(BaseEvent<List<BeanCourse>> event) {
        ...
        getActivity().runOnUiThread( () -> {
            ...
            for (int i = 0; i < mCourseList.size(); i++) {
                ...
                Button bt = findViewById(mCourseArray[positionDay][postionDetailTimeInTable]);
                //修改高度
                ...
                bt.setText(mCourseList.get(i).getDetail());
                ...
                bt.setBackgroundResource(mBackground[RandomUtil.getRandomFrom0(5)]);
